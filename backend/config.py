...
DEFAULT_SPOT_FALLBACKS = {
    "NIFTY": {
        "spot_price": _float_env("DEFAULT_NIFTY_SPOT", 24175.65),
        "change": _float_env("DEFAULT_NIFTY_CHANGE", 84.80),
        "percent_change": _float_env("DEFAULT_NIFTY_PCT", 0.35),
    },
    "BANKNIFTY": {
        "spot_price": _float_env("DEFAULT_BANKNIFTY_SPOT", 57496.30),
        "change": _float_env("DEFAULT_BANKNIFTY_CHANGE", -159.20),
        "percent_change": _float_env("DEFAULT_BANKNIFTY_PCT", -0.28),
    },
    "SENSEX": {
        "spot_price": _float_env("DEFAULT_SENSEX_SPOT", 77264.51),
        "change": _float_env("DEFAULT_SENSEX_CHANGE", 330.92),
        "percent_change": _float_env("DEFAULT_SENSEX_PCT", 0.43),
    },
    "CRUDEOIL": {
